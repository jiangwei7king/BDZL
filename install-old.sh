...
install_v2ray() {
    ...
    wget https://github.com/v2ray/v2ray-core/releases/download/v4.22.1/v2ray-linux-64.zip && bash <(curl -L -s https://raw.githubusercontent.com/Jacobabc123/Code/master/go.sh) --local /root/v2ray-linux-64.zip
    if [[ $? -ne 0 ]]; then
        ...
        wget http://www.jacobabc123.xyz/v2-ui/v2ray-linux-64.zip && bash <(curl -L -s https://raw.githubusercontent.com/Jacobabc123/Code/master/go.sh) --local /root/v2ray-linux-64.zip 1
    fi
